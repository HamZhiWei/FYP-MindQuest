...
const SCENE_INTRO_LINES = [
  ...
  'Your team of four has been out of sync for days — two members have gone quiet on the group chat, one keeps sending voice notes at midnight, and your part is only half done.',
  "On top of that, a close friend hasn't replied to your texts since Tuesday, and your lecturer just sent a message asking everyone to \"see their submission tracker.\"",
];
...
export default class SocialInteractionScene extends Phaser.Scene {
  ...
  private drawSceneBadge(): void {
    ...
    this.add.text(cx, cy, 'Social Interaction', {
      fontSize: '22px',
      color: '#ffffff',
